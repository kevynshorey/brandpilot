...
function LoginForm() {
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
      ...
      <p className="text-sm text-zinc-400 mb-6">Welcome back to BrandPilot</p>

      <button
        onClick={handleGoogleLogin}
        className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-zinc-900 rounded-lg font-medium text-sm hover:bg-zinc-100 transition-colors mb-4"
      >
